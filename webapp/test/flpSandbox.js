		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Tutorial",
									"targetURL": "#sapbtpwizard-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpwizard-display": {
								"semanticObject": "sapbtpwizard",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.wizard",
									"url": sap.ui.require.toUrl("sap/btp/wizard")
								}
							}
						}
					}
